...
test('Visitor', function (troot) {
  ...
  troot.test('createVisitor', function (t) {
    var visitor = Visitor.createVisitor({ email: 'test@mail.com', password: '12345' });
  ...
  test('registerNew', function (t) {
    ...
    t.test('valid input', function (t) {
      ...
      var newVis = {};
      var stubCreate = sinon.stub(Visitor, 'createVisitor', function (candidate) {
        t.pass('call createVisitor');
      ...
      Visitor.registerNew({ email: 'test@mail.com', password: '12345' }, function (err, visitor) { 
        ...
        Visitor.createVisitor.restore(); // remove sinon.stub
      });
    });
    ...
    t.test('crush encryptPassword', function (t) {
      ...
      Visitor.registerNew({ email: 'test@mail.com', password: '12345' }, function (err, visitor) { 
        ...
        Visitor.encryptPassword.restore(); // remove sinon.stub
      });
    });
  });
